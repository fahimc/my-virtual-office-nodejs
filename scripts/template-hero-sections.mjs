...
function centeredCarousel(template, images) {
  return `<div class="relative min-h-[430px] overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#1d1738] via-[#271d4b] to-[#090914] p-5 text-white shadow-2xl md:min-h-[560px] md:p-8">
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_50%_28%,rgba(139,92,246,.4),transparent_26rem)]"></div>
...
function kineticPersona(template, images) {
  return `<div class="relative min-h-[430px] overflow-hidden rounded-[2rem] bg-[#11131d] text-white shadow-2xl md:min-h-[560px]">
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_55%_45%,rgba(239,68,68,.34),transparent_18rem),radial-gradient(circle_at_38%_42%,rgba(34,211,238,.22),transparent_14rem)]"></div>
    ...
    <div class="relative z-10 flex min-h-[430px] flex-col justify-between p-5 md:min-h-[560px] md:p-8">
      ...
      <div class="grid gap-5 md:grid-cols-[.9fr_1.1fr_.75fr]">
        <div class="self-center">
          <span class="text-xs font-bold uppercase tracking-[.35em] text-cyan-200">${escapeHtml(template.badge)}</span>
...
function interiorSplitPanel(template, images) {
  return `<div class="grid min-h-[430px] overflow-hidden rounded-[2rem] bg-base-100 shadow-2xl md:min-h-[560px] md:grid-cols-[1.15fr_.85fr]">
    ...
    <div class="flex flex-col justify-between bg-orange-400 p-6 text-neutral md:p-8">
      ${miniNav(template, 'bg-white/20 text-neutral border-neutral/10')}
      <div>
        ...
        <p class="mt-5 max-w-md text-neutral/75">${escapeHtml(template.subhead)}</p>
      </div>
