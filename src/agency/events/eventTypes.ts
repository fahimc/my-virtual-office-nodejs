export type AgencyEventType =
  ...
  | 'project.completed'
  | 'client_portal.project.viewed'
  | 'client_portal.update.published'
  | 'client_portal.design.published'
  | 'client_portal.design.viewed'
  | 'client_portal.design.approved'
  | 'client_portal.design.changes_requested'
  | 'client_portal.preview.created'
  | 'client_portal.preview.published'
  | 'client_portal.preview.viewed'
  | 'client_portal.preview.approved'
  | 'client_portal.preview.changes_requested'
  | 'client_portal.feedback.created'
  | 'client_portal.feedback.converted_to_task'
  | 'client_portal.file.uploaded'
  | 'client_portal.message.sent'
  | 'client_portal.approval.created'
  | 'client_portal.approval.approved'
  | 'client_portal.approval.rejected'
  | 'client_portal.launch.approved'
  | 'workflow.paused'
  | 'workflow.failed'
  | 'workflow.resumed';
